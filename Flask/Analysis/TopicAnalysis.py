...
loaded_model = joblib.load(open("comment_topic_model.sav", 'rb'))
loaded_tfidf = joblib.load(open("comment_tfidf.sav", 'rb'))

#input comments for model analysis
new_comments = pd.read_csv('PIC16BProject/Flask/input.csv')
...
print(posTopicList) # CORRECT TOPIC NUMBERS AS DISPLAYED ON GRAPH
...
print(negTopicList) # CORRECT TOPIC NUMBERS AS DISPLAYED ON GRAPH
